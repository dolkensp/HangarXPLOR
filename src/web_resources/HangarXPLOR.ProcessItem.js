...
HangarXPLOR.ProcessItem = function()
{
  ...
  if (pledgeName.length > 0) {
    ...
    if (HangarXPLOR._setting.NoPledgeID != true) this.displayName = titleParts[0] + ' - ';
    else this.displayName = '';
    
    if (HangarXPLOR._setting.NoNickname != true && this.hasNickname && this.isShip) this.displayName += this.nickname;
    else this.displayName += titleParts[1];
